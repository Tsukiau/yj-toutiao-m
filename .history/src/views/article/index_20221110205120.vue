    ...
    <div class="main-wrap">
      ...
      <div v-else-if="article.title" class="article-detail">
        ...
        <van-divider>正文结束</van-divider>
          <!-- 展示文章评论列表 -->
          <CommentList 
          @onComment="onComment_total_count = $event.total_count"
...
import CommentList from './components/article-comment.vue'
export default {
  name: 'ArticleIndex',
  components: { follow_user, collect,Like,CommentList },
  props: {
    articleId: {
      type: [Number, String],
      required: true
