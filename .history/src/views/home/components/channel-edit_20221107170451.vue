...
export default {
  ...
  methods: {
    ...
    // filter + some 
    recommendChannels(){
       this.arr =  this.allChannels.filter(arritem => !this.myChannels.some( item => item.id === arritem.id))
       console.log(this.arr)
    },
    // filter + some 
    recommendChannels1(){
    this.arr =  this.allChannels.filter(arritem => !this.myChannels.find( item => item.id === arritem.id))
    console.log(this.arr)
    }
  }
}
