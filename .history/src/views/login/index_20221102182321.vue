    ...
    <van-form ref="loginForm" @submit="onSubmit">
      ...
      v-model="user.code"
       type="number"
        ...
        <van-button round slot="button" size="small"
         native-type="button" type="default" @click="onSendSms">发送验证码
        </van-button>
        <!--  -->
      </van-field>
...
export default {
  ...
  methods: {
    ...
    // 登录
    async onSubmit (a) {
      this.$refs.loginForm.vaildate(v => {
         if(!v) return this.message.error('1')
      })
